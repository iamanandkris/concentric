 ...
 * [[io.dsentric.annotations.FieldValidator]] classes named in
 ...
 */
private[dsentric] object ValidatorHelper:
  ...
  def make(className: String): Any => List[String] =
    val inst =
      Class
        ...
        .newInstance()
        .asInstanceOf[io.dsentric.annotations.FieldValidator[Any]]
   ...
   *
   * The class must implement [[io.dsentric.ContractValidator]][T] and have
  ...
  def makeContractValidator[T](className: String): T => List[String] =
    val inst =
      Class
        ...
        .getDeclaredConstructor()
        .newInstance()
        .asInstanceOf[io.dsentric.ContractValidator[T]]
    (t: T) => inst.validate(t)
